...
void USART_Vofa_Justfloat_Transmit(float SendValue1,float SendValue2,float SendValue3,float SendValue4){
 
    __attribute__((section (".AXI_SRAM")))  static uint8_t Rx_Buf[20];
